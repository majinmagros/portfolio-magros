...
export default class Resources extends EventEmitter
{
    constructor()
    {
        ...
        this.loader.load([
            ...
            { name: 'introPBase', source: './models/intro/p/base.glb' },
            { name: 'introPCollision', source: './models/intro/p/collision.glb' },
            ...
            // Video projects (magros)
            { name: 'projectsVid1Floor', source: './models/projects/6TXC5G8ecrY/floorTexture.png', type: 'texture' },
            { name: 'projectsVid2Floor', source: './models/projects/lTjxgOQEK0U/floorTexture.png', type: 'texture' },
            { name: 'projectsVid3Floor', source: './models/projects/GdcuXYKnJzQ/floorTexture.png', type: 'texture' },
            { name: 'projectsVid4Floor', source: './models/projects/ilRqtcjwmUI/floorTexture.png', type: 'texture' },
            { name: 'projectsVid5Floor', source: './models/projects/BTKcgvYx81o/floorTexture.png', type: 'texture' },
            { name: 'projectsVid6Floor', source: './models/projects/0rDahsPYsuw/floorTexture.png', type: 'texture' },
            { name: 'projectsVid7Floor', source: './models/projects/b3bEWOfiyX4/floorTexture.png', type: 'texture' },
            { name: 'projectsVid8Floor', source: './models/projects/16yZ6EtZ9cE/floorTexture.png', type: 'texture' },
            { name: 'projectsVid9Floor', source: './models/projects/X6qUXQNrGck/floorTexture.png', type: 'texture' },
            { name: 'projectsVid10Floor', source: './models/projects/16GcWSNAukk/floorTexture.png', type: 'texture' },
            { name: 'projectsVid11Floor', source: './models/projects/_urGBUhH1yI/floorTexture.png', type: 'texture' },
            { name: 'projectsVid12Floor', source: './models/projects/YGNeX2oS7Hw/floorTexture.png', type: 'texture' },
            { name: 'projectsVid13Floor', source: './models/projects/jkz_8LCdwb8/floorTexture.png', type: 'texture' },
            { name: 'projectsVid14Floor', source: './models/projects/VhZqA0Lpw6A/floorTexture.png', type: 'texture' },
            { name: 'projectsVid15Floor', source: './models/projects/npSbYthBTo4/floorTexture.png', type: 'texture' },
            { name: 'projectsVid16Floor', source: './models/projects/3rua9eShUvQ/floorTexture.png', type: 'texture' },
            { name: 'projectsVid17Floor', source: './models/projects/5PGFT_V0WqY/floorTexture.png', type: 'texture' },
            { name: 'projectsVid18Floor', source: './models/projects/o4gCBe-Shsc/floorTexture.png', type: 'texture' },
            { name: 'projectsVid19Floor', source: './models/projects/nr0uJ5OT5Us/floorTexture.png', type: 'texture' },
            { name: 'projectsVid20Floor', source: './models/projects/-nX70DG4iEM/floorTexture.png', type: 'texture' },
            { name: 'projectsVid21Floor', source: './models/projects/8BDzg6pM5as/floorTexture.png', type: 'texture' },
            { name: 'projectsVid22Floor', source: './models/projects/Ya4g2Wwizt0/floorTexture.png', type: 'texture' },
            { name: 'projectsVid23Floor', source: './models/projects/rxoQ65YCSeE/floorTexture.png', type: 'texture' },
            { name: 'projectsVid24Floor', source: './models/projects/OvYhhKYvjGI/floorTexture.png', type: 'texture' },
            { name: 'projectsVid25Floor', source: './models/projects/bh9TcthCMXo/floorTexture.png', type: 'texture' },
            { name: 'projectsVid26Floor', source: './models/projects/3aYie-u93bQ/floorTexture.png', type: 'texture' },
            { name: 'projectsVid27Floor', source: './models/projects/b2iNwqheRcI/floorTexture.png', type: 'texture' },
            { name: 'projectsVid28Floor', source: './models/projects/_rF3OvKj_QY/floorTexture.png', type: 'texture' },
            { name: 'projectsVid29Floor', source: './models/projects/12PJPz12Zks/floorTexture.png', type: 'texture' },
            { name: 'projectsVid30Floor', source: './models/projects/a62ogSVllIk/floorTexture.png', type: 'texture' },
            { name: 'projectsVid31Floor', source: './models/projects/yE-DC6na78s/floorTexture.png', type: 'texture' },
            { name: 'projectsVid32Floor', source: './models/projects/72x9hi3zZsc/floorTexture.png', type: 'texture' },
            { name: 'projectsVid33Floor', source: './models/projects/onHts4ou9VQ/floorTexture.png', type: 'texture' },
            { name: 'projectsVid34Floor', source: './models/projects/6psUhxFXT6s/floorTexture.png', type: 'texture' },
            { name: 'projectsVid35Floor', source: './models/projects/nyRFpKrxxwg/floorTexture.png', type: 'texture' },
            { name: 'projectsVid36Floor', source: './models/projects/3xWSSlkd4OA/floorTexture.png', type: 'texture' },
            { name: 'projectsVid37Floor', source: './models/projects/ZU8pCRApdIY/floorTexture.png', type: 'texture' },
            { name: 'projectsVid38Floor', source: './models/projects/fToez0H0b24/floorTexture.png', type: 'texture' },
            { name: 'projectsVid39Floor', source: './models/projects/VijQJQUev5s/floorTexture.png', type: 'texture' },
            { name: 'projectsVid40Floor', source: './models/projects/Zf7V-rnzUmc/floorTexture.png', type: 'texture' },
            { name: 'projectsVid41Floor', source: './models/projects/kwezBVvpE4Y/floorTexture.png', type: 'texture' },
            { name: 'projectsVid42Floor', source: './models/projects/_SR8QLn7gVU/floorTexture.png', type: 'texture' },
            { name: 'projectsVid43Floor', source: './models/projects/E4TMRkQniWo/floorTexture.png', type: 'texture' },
            { name: 'projectsVid44Floor', source: './models/projects/SO0R5dDTl3Y/floorTexture.png', type: 'texture' },
            { name: 'projectsVid45Floor', source: './models/projects/4lYllo4L0d8/floorTexture.png', type: 'texture' },
            { name: 'projectsVid46Floor', source: './models/projects/5-k3_lFRLHA/floorTexture.png', type: 'texture' },
